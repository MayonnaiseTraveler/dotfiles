...
- [ ] convert project files to png
- [ ] Create Own Script To Create Blogs based on LB Script
...
- [ ] Remake the blog page with decent PHP
- [ ] Create own bash script to manage the blog trought the backend!
...
## Blog Ideas
- [ ] blog post about the unknown parts of internet
- [ ] add Fursona generator!
