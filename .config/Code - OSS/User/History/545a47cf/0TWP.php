<section class="cardnew art">
    ...
    <section id="carrousel">
        ...
        for ($i = 0; $i < 3; $i++) {
            ...
            printf("<a href='./art.html' class='imagecontainer' style='background-image:url(%s%s)'><img  class='imageswitch async-image'  loading='lazy' src='%s%s'/> </a>", $dir_thumb,  $thumbname );
        }
        ?>
