    ...
    foreach ($entries as $i) {
        ...
        switch ($mode) {
            case 1:
                ...
                printf("<br><li class='index-item'>  <small>%s</small> - <a href='./blog.html#%s'> %s </a> </li>", $date, $basefiledir, $name);
                break;
            case 2:
                //Print BlogNews (latest 3 blogs in the index, without topics)
                if ($n < 3) {
                    printf("<li> <small>%s</small> - <a href='./blog.html#%s'> %s </a> </li>", $date, $basefiledir, $name);
                }
                $n++;
                break;
            case 3:
