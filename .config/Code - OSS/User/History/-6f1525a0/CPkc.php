...
*
* @param mode $mode There are 3 modes: \n mode 1 prints a blog index where different folders are shown as different topics, mode 2 prints a simpler blog index with the latest 3 blog posts, and mode 3 prints the actual contents of the blog post 
*
