...
<body class="gridmain">
        ...
        <main class="cardnew" style="grid-area:center;">
                ...
                ?>       
                <script src="../js/carrousel.js" onload="start('#carrousel',false,1)"></script>
                
                </div>
                <button id="btn-comic-prev" onclick="start('#carrousel',false,-1)"> prev</button>
                <button id="btn-comic-next" onclick="start('#carrousel',false,1)">next </button>
        </main>
