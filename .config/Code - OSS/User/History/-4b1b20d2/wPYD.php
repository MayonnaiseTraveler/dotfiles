<section class="cardnew art carrousel">
    ...
    <section id="carrousel" class="nobar" data-pos="0">
        ...
        <script src="../js/carrousel.js" onload="start('#carrousel','imagecontainer',true,1)"></script>
    </section>
    <btn id="carrousel-btn-left" onclick="start('#carrousel','imagecontainer',false,-1);"></btn>
    <btn id="carrousel-btn-right" onclick="start('#carrousel','imagecontainer',false,1);"></btn>
</section>