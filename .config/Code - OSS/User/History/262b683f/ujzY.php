  <header>
    <h1 class="titleblog"> Anyone Can Learn Art!!
    </h1>
    
    <date class="date">Last Modified:<?php echo date("d M Y ", filectime(__FILE__)); ?></date>
    <p class="subtitle"> Subtitle here</p>
  </header>

  <section class="clearfix">
    <img src="/media/gifs/neco-arc-neco.gif" alt="">
