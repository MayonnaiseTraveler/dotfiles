...
<body class="gridmain">
    ...
    <aside class="nomargin" style="grid-area:left;">
        ...
        <section class="cardnew nomargin">
            <iframe src="https://www5.cbox.ws/box/?boxid=934146&boxtag=RLyDL0" width="100%" height="300px" allowtransparency="yes" allow="autoplay" frameborder="0" marginheight="5%" marginwidth="5%" scrolling="auto"></iframe>
        </section>
    </aside>
