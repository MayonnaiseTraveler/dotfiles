...
<body class="gridmain">
    ...
    <aside class="nomargin" style="grid-area:left;">
        ...
        <section class="cardnew nomargin">
            <iframe src="https://www5.cbox.ws/box/?boxid=934146&boxtag=RLyDL0" width="100%" height="300px" allowtransparency="yes" allow="autoplay" frameborder="10" marginheight="0" marginwidth="0" scrolling="auto"></iframe>
        </section>
    </aside>
