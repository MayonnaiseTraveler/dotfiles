...
<body class="gridmain">
    ...
    <aside class="nomargin" style="grid-area:left;">
        ...
        <section class="cardnew nomargin">
            <div style="padding:1vw;">
                <h3>Chat</h3>
                <hr>
            </div>
            <iframe style="margin:1vw;"src="https://www5.cbox.ws/box/?boxid=934146&boxtag=RLyDL0" width="100%" height="300px" allowtransparency="yes" allow="autoplay" frameborder="0" marginheight="0" marginwidth="0" scrolling="auto"></iframe>
        </section>
    </aside>
