...
<body class="gridmain">
    ...
    <aside class="nomargin" style="grid-area:right;">
        <section class="cardnew">
            <iframe src="https://www5.cbox.ws/box/?boxid=934146&boxtag=RLyDL0" width="100%" height="10vw" allowtransparency="yes" allow="autoplay" frameborder="0" marginheight="0" marginwidth="0" scrolling="auto"></iframe>	          
        </section>
